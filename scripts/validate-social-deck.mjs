 ...
 *
 *   node scripts/validate-social-deck.mjs <task-dir|index.html>
 *
...
if (!target) {
  console.error("usage: node scripts/validate-social-deck.mjs <task-dir|index.html> [--style=swiss|editorial]");
  process.exit(2);
}
